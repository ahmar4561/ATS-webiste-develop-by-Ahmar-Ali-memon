...
const CERT_WIDTH = 1500;
const CERT_HEIGHT = 1061;
...
function buildCertificateSvg(
  { studentName, testTitle, rank, score, percentage }: CertificateProps,
  ...
  <g transform="translate(88,${CERT_HEIGHT - 108})">
    ...
    <text x="50" y="18" font-family="Arial,sans-serif" font-size="18" font-weight="600" fill="#14245A">21 June 2026</text>
...
export function CertificateModal({
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // Render at 2x for a crisp, high-resolution download.
      const SCALE = 2;
