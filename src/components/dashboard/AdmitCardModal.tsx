    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="bg-white rounded-2xl p-6 max-w-2xl w-full">
        <div className="flex items-center gap-2 mb-4">
          <IdCard className="w-6 h-6 text-gold-500" />
        ...
        <div className="rounded-xl overflow-hidden border border-slate-200 mb-6 bg-slate-50">
          {previewUrl ? (
            ...
            <img src={previewUrl} alt="Admit card preview" className="w-full" />
          ) : genError ? (
            ...
            <div className="aspect-[1050/650] flex items-center justify-center text-slate-400 animate-pulse">
        ...
        <p className="text-sm text-slate-500 mb-4">
          Print this and bring the hard copy along with your original CNIC / student card to the test venue.
        </p>
