...
export default function EnrollPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.success && result.rollNumber) {
      ...
      setAssignedPassword(result.password ?? null);
      ...
      <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
        <Card className="w-full max-w-lg shadow-xl">
          <CardContent className="text-center pt-8 pb-8">
            ...
            <p className="text-sm text-slate-500 mb-6">
              This is your unique Roll Number and a temporary password. You
              will need both to log in — please save them carefully. You
              can change your password anytime from your Dashboard.
            </p>

            <div className="bg-slate-50 border-2 border-dashed border-emerald-300 rounded-xl py-5 px-4 mb-4">
              <p className="text-xs text-slate-500 mb-1 uppercase tracking-wider">
                Your Roll Number
              </p>
              <div className="flex items-center justify-center gap-3">
