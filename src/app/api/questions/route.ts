...
import { getStudentAttempts, getPhysicalRegistrationForStudent } from "@/lib/storage";
...
export async function GET(request: NextRequest) {
  ...
  if (test.mode === "physical") {
    ...
    // registration for this specific test has been confirmed by the admin
    // (e.g. out-of-city students taking it remotely instead of in person).
    if (!rollNumber) {
