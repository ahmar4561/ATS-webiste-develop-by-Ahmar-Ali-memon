...
export function buildAdmitCardSvg(
  ...
  <g transform="translate(70,486)">
    ...
    <text x="18" y="44" font-family="Arial,sans-serif" font-size="12.5" fill="#78350F">Print this Admit Card and bring it, along with your original CNIC / student card, to the test venue.</text>
