...
export const TESTS: TestDefinition[] = [
  {
    ...
    staticTop10: [
      ...
      { rank: 9,  name: "Saira Chandio",      city: "",      score: 151, totalMarks: 180 },
    ],
  ...
  },
  {
    ...
    // Top 10 from the District Dadu merit list (poster). Hardcoded because
    // the live database was migrated to a fresh Neon project and no longer
    // has these attempt records — same pattern as test-1's staticTop10.
    // Uses DENSE ranking (1-2-2-3-3-4...), matching getMeritList()'s own
    // ranking algorithm exactly: tied scores share the same rank number,
    // and the next distinct score continues at the very next whole number
    // (no skipping). TodaysToppers shows the first 10 *rank positions*,
    // however many students that works out to.
    staticTop10: [
      { rank: 1,  name: "Ahmed Ali",       city: "Dadu", score: 169, totalMarks: 180 },
      { rank: 2,  name: "Ayaz Ali",        city: "Dadu", score: 165, totalMarks: 180 },
      { rank: 2,  name: "Muhammad Ismail", city: "Dadu", score: 165, totalMarks: 180 },
      { rank: 3,  name: "Muhammad Ali",    city: "Dadu", score: 164, totalMarks: 180 },
      { rank: 3,  name: "Muzamil Ali",     city: "Dadu", score: 164, totalMarks: 180 },
      { rank: 4,  name: "Aftab Ali",       city: "Dadu", score: 163, totalMarks: 180 },
      { rank: 5,  name: "Yasir Ali",       city: "Dadu", score: 162, totalMarks: 180 },
      { rank: 5,  name: "Yasir Jamali",    city: "Dadu", score: 162, totalMarks: 180 },
      { rank: 6,  name: "Areej",           city: "Dadu", score: 161, totalMarks: 180 },
      { rank: 6,  name: "Aisha",           city: "Dadu", score: 161, totalMarks: 180 },
      { rank: 6,  name: "Ajwa Jamali",     city: "Dadu", score: 161, totalMarks: 180 },
      { rank: 6,  name: "Shoaib Ali",      city: "Dadu", score: 161, totalMarks: 180 },
      { rank: 7,  name: "Rehan Ali",       city: "Dadu", score: 159, totalMarks: 180 },
      { rank: 8,  name: "Faiza Lashari",   city: "Dadu", score: 155, totalMarks: 180 },
      { rank: 9,  name: "Sajid Ali",       city: "Dadu", score: 152, totalMarks: 180 },
      { rank: 10, name: "Abdul Hanan",     city: "Dadu", score: 149, totalMarks: 180 },
      { rank: 10, name: "Mahnoor",         city: "Dadu", score: 149, totalMarks: 180 },
    ],
  },
  {
    // Registration is fully external (Google Form) — the admin manually
    // adds + confirms students in the admin panel after seeing the form
    // responses (Physical Test tab → "Add Manually").
    id: "final-mega-online-dadu",
    number: 7,
    title: "Final Online Mega Test",
    date: "2026-08-09",
    mode: "physical",
    isSunday: true,
  ...
  {
    id: "online-mega-nawabshah",
    number: 8,
    title: "Test 1 Online Mega Test for Nawabshah Students",
    date: "2026-08-07",
    mode: "physical",
    isSunday: false,
    externalRegistrationUrl: "https://forms.gle/vfeKTTXbUJnMfky87",
    registrationNote:
      "Fully Online Test — Fee: Rs. 400. Specially organized for Nawabshah students, but students from all over Pakistan can appear. Register using the Google Form below.",
    syllabus: {
      biology: "Complete MDCAT Syllabus Review",
      chemistry: "Complete MDCAT Syllabus Review",
      physics: "Complete MDCAT Syllabus Review",
...
export function getLatestClosedTest(now: Date = new Date()): TestDefinition | undefined {
  ...
  const closed = TESTS.filter((t) => {
    ...
    if (t.mode === "physical") {
      // Physical tests aren't gated by the 10 AM-10 PM online submission
      // window -- once their date has passed, results/Top 10 are final.
      return testKey < todayKey;
    }
